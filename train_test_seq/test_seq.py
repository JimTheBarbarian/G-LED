...
class Args_eval:
    def __init__(self):
        ...
        self.parser.add_argument("--train_args_txt", type=str, required=True, help='Path to args.txt from training')
        self.parser.add_argument("--model_path", type=str, required=True, help='Path to the trained model .pt file')
        # Data Args
