...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.enc_embedding = DataEmbedding_mine(configs.enc_in, configs.d_model,  configs.dropout)
        self.dec_embedding = DataEmbedding_mine(configs.dec_in, configs.d_model,  configs.dropout, is_decoder=True)
